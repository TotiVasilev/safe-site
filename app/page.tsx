  ...
  return (
    <main className="overflow-hidden bg-white text-black">
      ...
      <div className="lg:hidden">
          ...
          <div className="relative mx-auto max-w-xl">
            ...
            <Reveal direction="up" duration={0.9}>
              <div className="relative mt-5 h-[330px]">
                {/* SAFE SHADOW */}
                <div className="absolute bottom-9 left-1/2 h-9 w-[48%] -translate-x-1/2 rounded-[50%] bg-black/15 blur-xl" />

                {/* SAFE */}
                <div className="absolute left-1/2 top-[48%] h-[250px] w-[168px] -translate-x-1/2 -translate-y-1/2 bg-[#25292f] shadow-[20px_28px_50px_rgba(0,0,0,0.25)]">
                  <div className="absolute inset-x-0 top-0 h-px bg-white/20" />
                  <div className="absolute bottom-0 right-0 top-0 w-px bg-white/10" />

                  <div className="absolute inset-[7%] border border-white/10 bg-[#30353c] shadow-[inset_-10px_-8px_20px_rgba(0,0,0,0.24),inset_5px_5px_15px_rgba(255,255,255,0.025)]">
                    {/* LOCK */}
                    <div className="absolute right-[16%] top-[27%] flex h-12 w-12 items-center justify-center rounded-full border border-white/15 bg-[#202329]">
                      <div className="h-7 w-7 rounded-full border border-white/15 bg-[#343941]">
                        <div className="mx-auto mt-[5px] h-4 w-[2px] bg-white/35" />
                      </div>
                    </div>

                    {/* HANDLE */}
                    <div className="absolute right-[25%] top-[52%] h-16 w-[5px] -translate-y-1/2 bg-[#b7bcc2]">
                      <div className="absolute left-1/2 top-1/2 h-5 w-5 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#d0d4d8]" />
                    </div>

                    {/* BRAND */}
                    <span className="absolute bottom-[7%] left-[8%] text-[6px] font-medium uppercase tracking-[0.28em] text-white/25">
                      Tetraedar
                    </span>
                  </div>
                </div>
                ...
                {/* TOP LEFT POINTER */}
                <div className="absolute left-0 top-[13%] w-[34%]">
                  <p className="mb-2 text-[7px] uppercase leading-[1.45] tracking-[0.16em] text-[#3f7edb]">
                    Усилена
                    <br />
                    конструкция
                  </p>
                  ...
                  <div className="flex items-center">
                    <span className="h-1.5 w-1.5 shrink-0 rounded-full bg-[#3f7edb]" />
                    <span className="h-px flex-1 bg-[#3f7edb]/50" />
                  </div>
                </div>

                {/* BOTTOM RIGHT POINTER */}
                <div className="absolute bottom-[20%] right-0 w-[34%]">
                  <div className="flex items-center">
                    <span className="h-px flex-1 bg-[#3f7edb]/50" />
                    <span className="h-1.5 w-1.5 shrink-0 rounded-full bg-[#3f7edb]" />
                  </div>

                  <p className="mt-2 text-right text-[7px] uppercase leading-[1.45] tracking-[0.16em] text-[#3f7edb]">
                    Заключваща
                    <br />
                    система
                  </p>
                ...
                <div className="absolute bottom-2 right-0 text-right">
                  <p className="font-mono text-[8px] leading-4 text-black/30">
                    ТЕТРАЕДАР
                    <br />
                    БЪЛГАРИЯ
                  </p>
            ...
            <div className="mt-14 border-y border-black/10">
              <div className="border-b border-black/10 py-7">
                <div className="flex items-start gap-5">
                  <div className="mt-2 h-2 w-2 shrink-0 rounded-full bg-[#3f7edb]" />
        ...
        ======================================================= */}
        <section className="relative overflow-hidden bg-[#171a1f] px-5 py-20 text-white">
          <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(to_right,rgba(255,255,255,0.035)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.035)_1px,transparent_1px)] bg-[size:48px_48px]" />
          ...
          <div className="relative">
            ...
            {/* PRODUCT SAFE */}
            <Reveal direction="up">
              <div className="relative mt-10 h-[365px] border-y border-white/10">
                <div className="absolute inset-0 flex items-center justify-center">
                  {/* GLOW */}
                  <div className="absolute h-[250px] w-[250px] rounded-full bg-[#3f7edb]/10 blur-[65px]" />

                  {/* SAFE */}
                  <div className="relative h-[270px] w-[180px] bg-gradient-to-br from-[#4c535c] via-[#30353c] to-[#202328] shadow-[25px_35px_65px_rgba(0,0,0,0.5)]">
                    <div className="absolute inset-[7%] border border-white/10 bg-[#343a42] shadow-[inset_-9px_-8px_18px_rgba(0,0,0,0.18)]">
                      {/* LOCK */}
                      <div className="absolute right-[14%] top-[27%] h-12 w-12 rounded-full border border-white/15 bg-[#22262b]" />

                      {/* HANDLE */}
                      <div className="absolute right-[25%] top-[47%] h-20 w-[5px] bg-white/45" />
        ...
        {/* =======================================================
            MOBILE INQUIRY
        ======================================================= */}
        <section className="relative overflow-hidden bg-[#3f7edb] px-5 py-20 text-white">
